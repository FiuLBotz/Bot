...
const { Boom } = boom
const { default: kaylaConnect, useSingleFileAuthState, DisconnectReason, fetchLatestBaileysVersion, generateForwardMessageContent, generateWAMessage, prepareWAMessageMedia, generateWAMessageFromContent, generateMessageID, downloadContentFromMessage, makeInMemoryStore, jidDecode, proto, getContentType } = baileys
...
browser: ['𝐅𝐈𝐔𝐋-𝐁𝐎𝐓 (2023)','Safari','1.0.0'],
auth: state,
version
})
...
if (anu.action == 'add') {
kayla.sendMessage(anu.id, { text : `Hello @${num.split("@")[0]}, Welcome To The Group ${metadata.subject}, Semoga Gak Betah Di sini v;`, mentions : [num]},{ quoted : {
key: {
fromMe: false, 
...
kayla.sendMessage(anu.id, { text : `Dada @${num.split("@")[0]}, Jangan Balik Lagi ya...`, mentions : [num]},{ quoted : {
key: {
fromMe: false, 
participant: `0@s.whatsapp.net`, 
...({ remoteJid: "status@broadcast" }) 
...
"url": `https://www.youtube.com/channel/UCs6_PmL5XM7KB3gIOOyx2gA`,
"productImageCount": 1,
